...
CREATE TABLE SottoAmministratore ( Username VARCHAR(255) PRIMARY KEY, Nome VARCHAR(255), Cognome VARCHAR(255), Password VARCHAR(255), Ruolo VARCHAR(255), Amministratore_Username VARCHAR(255), CodiceValidazione INT(6), FOREIGN KEY (Amministratore_Username) REFERENCES Amministratore(Username) ); 
